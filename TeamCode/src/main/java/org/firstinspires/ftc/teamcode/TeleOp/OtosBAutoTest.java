...
//        Object robotDrive = robot.DriveForward;
        ...
        // Debugging: Initial position values
        telemetry.addData("Initial X", pos.x);
        telemetry.addData("Initial Y", pos.y);
        telemetry.update();
        ...
        while (pos.x > -1.5) { //distance is dependent on speed - current is 1 - 2
            ...
            telemetry.addData("X", "%.2f", pos.x);  // Log X position
            telemetry.addData("Y", "%.2f", pos.y);  // Log Y position
            telemetry.update();
